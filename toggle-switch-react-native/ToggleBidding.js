...
export default class ToggleBidding extends React.Component {
  ...
  dimensions = ToggleBidding.calculateDimensions(this.props.size);

  createToggleBiddingStyle = () => [
    {
  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        ...
        <TouchableOpacity
          style={this.createToggleBiddingStyle()}
          activeOpacity={0.8}
