...
export default class ToggleSwitch2 extends React.Component {
  ...
  dimensions = ToggleSwitch2.calculateDimensions(this.props.size);
    ...
    return (
      <View style={styles.container}>
        ...
        >
          ...
          >
            <Image
              source={require("./one-to-many.png")}
              style={{
                width: 20,
                height: 20,
                alignSelf: "center",
